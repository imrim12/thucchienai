...
class VectorizationJob(Base):
    ...
    # Job status
    status: Mapped[str] = mapped_column(String(20), default="pending", nullable=False)  # VectorizationStatus enum
    ...
    error_details: Mapped[Optional[dict]] = mapped_column(JSON)  # Detailed error information
    ...
    created_by: Mapped[Optional[str]] = mapped_column(String(100))  # User who started the job
