...
class DatabaseConnection(Base):
    ...
    # Connection details
    db_type: Mapped[str] = mapped_column(String(20), nullable=False)  # DatabaseType enum
    ...
    connection_params: Mapped[Optional[dict]] = mapped_column(JSON)  # SSL, timeout, etc.
    
    # Status
    is_active: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
    last_tested: Mapped[Optional[datetime]] = mapped_column(DateTime)
    test_status: Mapped[Optional[str]] = mapped_column(String(20))  # ConnectionStatus enum
    ...
    # Relationships
    table_configs = relationship("TableConfig", back_populates="database_connection", cascade="all, delete-orphan")
